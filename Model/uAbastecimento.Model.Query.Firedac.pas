unit uAbastecimento.Model.Query.Firedac;

interface

uses
  System.SysUtils, uAbastecimento.Model.Interfaces, FireDAC.DApt,
...
uses
  uAbastecimento.Model.Conexao.Firedac;
